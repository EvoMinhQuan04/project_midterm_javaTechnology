...
public class AuthControllerTest {
    ...
    public void registerUser_validRequest_success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(jsonPath("user.email").value("415quancao@gmail.com"))
                .andExpect(jsonPath("user.name").value("Cao Minh Quân"))
                .andExpect(jsonPath("user.phoneNumber").value("035367021"))
    ...
    public void registerUser_emailInvalid_fail() throws Exception {
        ...
        // GIVEN
        request.setEmail("caominhquan.com");
        ObjectMapper objectMapper = new ObjectMapper();
        String content = objectMapper.writeValueAsString(request);
    ...
    public void registerUser_phoneNumberInvalid_fail() throws Exception {
        ...
        // GIVEN
        request.setPhoneNumber("035367021");
        ObjectMapper objectMapper = new ObjectMapper();
        String content = objectMapper.writeValueAsString(request);
